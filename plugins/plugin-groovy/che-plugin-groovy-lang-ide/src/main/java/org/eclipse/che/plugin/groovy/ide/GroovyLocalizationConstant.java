 ...
 * 'GroovyLocalizationConstant.properties'.
 *
 */
public interface GroovyLocalizationConstant extends Messages {
    @Key("groovy.action.create.file.title")
    String createGroovyFileActionTitle();

    @Key("groovy.action.create.file.description")
    String createGroovyFileActionDescription();
